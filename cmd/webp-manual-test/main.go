...
// This build tag means that "go install github.com/Anykey-Nomad/image-simd/..." doesn't
...
package main // import "github.com/Anykey-Nomad/image-simd/cmd/webp-manual-test"
...
import (
	...
	"github.com/Anykey-Nomad/image-simd/webp"
)
