...
go test github.com/Anykey-Nomad/image-simd/font/sfnt -args -proprietary
...
go test github.com/Anykey-Nomad/image-simd/font/sfnt -test.run=ProprietaryMicrosoft -args -proprietary etc
*/
